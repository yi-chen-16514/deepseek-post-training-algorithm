...
下面我们将把一个给定文本([https://github.com/yi-chen-16514/deepseek-post-training-algorithm/blob/main/the-verdict.txt](https://raw.githubusercontent.com/yi-chen-16514/deepseek-post-training-algorithm/refs/heads/main/the-verdict.txt))的内容分割成多个词元的组合，然后把每个词源再转换为可以计算的向量。首先我们先通过代码获取文本内容，然后查看一下文本的一些信息:
```py
...
上面代码运行后所得结果如下:
1139
也就是说我们从文档中分割出了1139个单词，每个单词或分割出来的单元就是一个词元。
